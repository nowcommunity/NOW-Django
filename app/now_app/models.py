...
class NowVExportNaspecies(models.Model):
    ...
    age_comm = models.CharField(db_collation='utf8mb4_general_ci')
    basin = models.CharField(db_collation='utf8mb4_general_ci')
    subbasin = models.CharField(db_collation='utf8mb4_general_ci')
